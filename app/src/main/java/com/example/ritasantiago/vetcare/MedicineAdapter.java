...
public class MedicineAdapter extends RecyclerView.Adapter<MedicineAdapter.ViewHolder>{
    ...
    public MedicineAdapter(List<String> myDataset) {
        values = myDataset;
    }
    ...
    public MedicineAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        LayoutInflater inflater = LayoutInflater.from(
                parent.getContext());
        View v = inflater.inflate(R.layout.fragment_item_medicine, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.med_dosage.setText(name);
        holder.med_period.setText(name);
    }
